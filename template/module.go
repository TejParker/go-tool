...
require (
	github.com/TejParker/common v0.0.0-20220913123407-af94ee6eb5c3
	...
	//k8s.io/api v0.22.4 //error occur if other version
	//k8s.io/client-go v0.22.4 //error occur if other version
)
`
...
require (
	github.com/TejParker/common v0.0.0-20230913123407-af94ee6eb5c3
	github.com/afex/hystrix-go v0.0.0-20180502004556-fa1af6a1f4f5
	github.com/asim/go-micro/plugins/registry/consul/v3 v3.7.0
	github.com/asim/go-micro/plugins/wrapper/ratelimiter/uber/v3 v3.7.0
	github.com/asim/go-micro/plugins/wrapper/trace/opentracing/v3 v3.7.0
